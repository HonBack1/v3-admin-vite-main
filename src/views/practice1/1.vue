...
<template>
  <div class="contenr">
    ...
    <el-card>
      <el-button plain @click="centerDialogVisible = true">添加</el-button>
      ...
      <el-dialog v-model="centerDialogVisible" title="Warning" width="500" align-center>
        ...
        >
          <el-form-item label="用户名" prop="username">
            <el-input placeholder="请输入" v-model="CheckData.username" disabled
          /></el-form-item>
          <el-form-item label="邮箱" prop="email" disabled>
            <el-input placeholder="请输入" v-model="CheckData.email" disabled
          /></el-form-item>
        </el-form>
        <template #footer>
          <div class="dialog-footer">
